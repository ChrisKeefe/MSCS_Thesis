...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\listadd{\titlelines}%
  {IMPROVING IN SILICO SCIENTIFIC REPRODUCIBILITY IN QIIME 2}             %<Enter the title of the dissertation
\listadd{\titlelines}%
  {WITH SOFTWARE FOR PROVENANCE REPLAY}            % If you want to
                                        %   split the title across lines,
                                        %   use another \listadd command for the
                                        %   second line
\newcommand*\Author{Christopher R. Keefe}          %<Enter your name; must match official transcript
\newcommand*{\documentname}%
  {Thesis}                        %<Enter the type of document (capitalized)
\newcommand*{\degreename}
  {Master of Science \ \\ in Computer Science}                %<Enter the type of degree (capitalized)
\listadd{\committeechair}{J. Gregory Caporaso, Ph.D.}   %<Enter committee chair name; use \listadd for
...
\newcommand*{\chairlabel}{Chair}        %<If you have co-chairs, replace this text with
                                        %   'Co-Chair'
\listadd{\committeemember}{Nicholas Bokulich, Ph.D.} %<Enter committee member names; use \listadd for
\listadd{\committeemember}{Marco Aurelio Gerosa, Ph.D.} %   additional names
...
\newcommand*{\titlepageASU}{
  ...
  \thispagestyle{empty}
    ...
    \SingleSpacing
    Northern Arizona University \\[\baselineskip]
    \graddate
...
\newcommand{\bibfilename}{%             %<Enter the name of the *.bib file containing the
  src/content/references%                   %   reference information for sources cited in
...
\edef\pdfsummary{%                      % Build pdf summary
  A \documentname
  Submitted in Partial Fulfillment
  of the Requirements for the \degreename\space
  of \degreename}
...
\begin{center}
    ...
    \DoubleSpacing
\end{center}
\input{src/content/abstract}             %<Enter the name of the .tex file containing your
\clearpage                              %   your abstract or omit this line and type in
                                        %   your abstract here.
...
\input{src/content/acknowledgments}      %<Enter the name of the .tex file containing your
...
\input{src/content/dedication}           %<Enter the name of the .tex file containing your
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\mainmatter
\include{src/content/chapter1}          %<Insert your chapters here; I recommend to use
\include{src/content/chapter2}          %   \include rather than \input for chapters
\include{src/content/chapter3}
\include{src/content/chapter4}
\include{src/content/chapter5}
...
\makeatletter                           % Clear page after printing appendix title
  ...
  {%
    % \clearpage                          % Comment this out to begin appendix content on App. title page
...
\input{src/content/appendix_README}            %~Insert your appendices here; I recommend to use
\input{src/content/appendix_FGScript}            %   \input rather than \include for appendices.
\input{src/content/appendix_Survey}            %   All heading commands are the same as above,
\input{src/content/appendix_TAM_res}            %   e.g., \chapter, \section, etc.
\input{src/content/appendix_feature_use}
\input{src/content/appendix_tech_use}
\input{src/content/appendix_FGTranscripts}
\input{src/content/appendix_CLIHelp}
\input{src/content/appendix_CLIScript}
\input{src/content/appendix_PythonScript}
\input{src/content/appendix_citations}
\input{src/content/appendix_glossary}
