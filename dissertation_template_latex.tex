...
\else 									                % If xetex or luatex
  ...
  %
  \setmainfont[
    Path          = fonts/,                       % This is the parent dir filepath
    Extension     = .ttf ,                        % the font file's extension
    UprightFont   = * ,                           % the following are suffixes
    ItalicFont    = *i ,                          % filepaths are concatenated from [path][main font name][suffix][extension]
    BoldFont      = *bd ,                         % e.g. /usr/share/fonts/truetype/timesi.ttf
  ...
  ]{times}                              %<Set the main font; make sure the font is correct
