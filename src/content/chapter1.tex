...
Archives are formally defined and registered in the QIIME 2 \texttt{Archiver} code, and
...
\begin{itemize}
    ...
    \item Data and provenance are stored separately, allowing provenance data
        ...
        preferred data structure. We need not concern ourselves with the contents of
        the data directory here.
    \item The provenance directory of an Archive (if present) contains the
        ...
        alongside a non-hierarchically-organized artifacts directory containing
