...
\input{src/content/appendixA}            %~Insert your appendices here; I recommend to use
\input{src/content/appendixB}            %   \input rather than \include for appendices.
\input{src/content/appendixC}            %   All heading commands are the same as above,
\input{src/content/appendixD}            %   e.g., \chapter, \section, etc.
\input{src/content/appendixE}
\input{src/content/appendixF}
\input{src/content/appendixG}
\input{src/content/appendixH}
\input{src/content/appendixI}
\input{src/content/appendixJ}
